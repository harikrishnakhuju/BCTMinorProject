	\pagenumbering{roman}
		...
		\begin{normalsize}
			\justify
This is to  certify that this minor project  work entitled \textbf{“Facial Recognition Attendance System Using OpenCV”} submitted by Govinda Bista, Hari Krishna Khuju,
Subash Bhandari and Suresh Shrestha to the Department of Computer Engineering in partial fulfillment of requirement for
...
Department of Computer Engineering, KhCE\\
		...
		\normalsize
		\justify
		The author has agreed that the library, Khwopa College of Engineering may make this report freely available for inspection. Moreover, the author
...
Department of Computer Engineering, KhCE in
...
We are deeply indebted to our teachers Er. Niranjan Bekoju for
...
Also, we would like to thank Er. Subhadra Joshi for providing valuable suggestions and
...
\\ 
        \begin{table}[hbt!]
            \begin{tabular}{l l}
				Govinda Bista & KCE/077/BCT/015\\
				Hari Krishna Khuju & KCE/077/BCT/016\\
				Subash Bhandari & KCE/077/BCT/037\\
				Suresh Shrestha & KCE/077/BCT/040\\
		    \end{tabular}
        \end{table}
		\break
\section{Abstract}
